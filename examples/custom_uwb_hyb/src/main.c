...
int rate = 100;    
    ...
    dists[0]=0;
       ...
       j=sprintf(dist_str,"    :T14:%.02lf:%.02lf:%.02lf:%d:%x:%d.%07d:%d.%07d:%d%s%s\r\n",dists[0],dists[1],dists[2],fix_mode,rtk_mode8,whole[1], fraction[1],whole[0], fraction[0],time_utc,pollAccelerometer());
        //j=sprintf(dist_str,"    :T2:accelerometer : %s\r\n",pollAccelerometer());
